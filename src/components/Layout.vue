  ...
  <div>
    ...
    <header class="header">
      ...
      <nav :class="{ open: isMenuOpen }">
        <RouterLink to="/shop" active-class="active" @click="closeMenu"><i class="fas fa-store"></i> Магазин
        </RouterLink>
        <RouterLink to="/order" @click="closeMenu"><i class="fas fa-pencil-ruler"></i> Заказать оформление</RouterLink>
        <RouterLink to="/support" @click="closeMenu"><i class="fas fa-question-circle"></i> Помощь</RouterLink>
      ...
      <div class="footer-content">
        ...
        <div class="footer-column">
          ...
          <ul class="footer-links">
            <li>
              <RouterLink to="/shop"><i class="fas fa-chevron-right"></i> Магазин</RouterLink>
            </li>
            <li>
              <RouterLink to="/order"><i class="fas fa-chevron-right"></i> Заказать оформление</RouterLink>
            </li>
            <li>
              <RouterLink to="/support"><i class="fas fa-chevron-right"></i> Помощь</RouterLink>
            </li>
          </ul>
        </div>
        <div class="footer-column">
          ...
          <ul class="footer-links">
            <li>
              <RouterLink to="/offer"><i class="fas fa-file-contract"></i> Договор оферты</RouterLink>
            </li>
            <li>
              <RouterLink to="/privacy"><i class="fas fa-shield-alt"></i> Политика конфиденциальности</RouterLink>
            </li>
          </ul>
        </div>
      </div>
