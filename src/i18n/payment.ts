...
export const payment: MessageBundle = {
  ru: {
    'payment.header.title': 'Оформление заказа',
    'payment.header.subtitle': 'Выберите удобный способ оплаты и завершите покупку',
    ...
    'payment.method.yookassa.desc': 'Карты Мир, SberPay',
    'payment.method.stripe': 'Stripe',
    'payment.method.stripe.desc': 'Visa / Mastercard / Amex',
    'payment.method.paypal': 'PayPal',
    'payment.method.paypal.desc': 'Visa / Mastercard',
    'payment.button.pay': 'Оплатить',
    'payment.secure': 'Безопасный платеж. Ваши данные защищены.',
  ...
  en: {
    ...
    'payment.header.subtitle': 'Choose a payment method and complete your purchase',
    ...
    'payment.method.yookassa.desc': 'MIR cards, SberPay',
    'payment.method.stripe': 'Stripe',
    'payment.method.stripe.desc': 'Visa / Mastercard / Amex',
    'payment.method.paypal': 'PayPal',
    'payment.method.paypal.desc': 'Visa / Mastercard',
