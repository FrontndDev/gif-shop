  ...
  <Layout>
    ...
    <div class="order-container">
      ...
      <div class="order-info">
        ...
        <div class="info-item"><h4><i class="fas fa-comments"></i> Консультация</h4><p>Обсуждаем ваши пожелания.</p></div>
        <div class="info-item"><h4><i class="fas fa-pencil-ruler"></i> Дизайн</h4><p>Создаем концепцию и правим по вашим замечаниям.</p></div>
        <div class="info-item"><h4><i class="fas fa-check-circle"></i> Утверждение</h4><p>Подтверждаем финальную версию.</p></div>
        <div class="info-item"><h4><i class="fas fa-rocket"></i> Реализация</h4><p>Загружаем оформление в ваш профиль.</p></div>
      </div>
    </div>
  </Layout>
</template>
...
.page-header h2 { font-size: 2.2rem; background: linear-gradient(90deg,#00cfff,#3399ff); -webkit-background-clip: text; -webkit-text-fill-color: transparent; margin-bottom: 15px; font-weight: 800; }
.order-container { max-width: 1200px; margin: 0 auto; padding: 0 5% 60px; display: grid; grid-template-columns: 1fr 1fr; gap: 40px; }
@media (max-width: 1024px) { .order-container { grid-template-columns: 1fr; } }
.order-form, .order-info { background: rgba(0, 15, 30, 0.45); padding: 30px; border-radius: 16px; border: 1px solid rgba(0, 207, 255, 0.2); }
.form-row { display: grid; grid-template-columns: 1fr 1fr; gap: 15px; }
.form-group { margin-bottom: 20px; }
.form-group label { display: block; margin-bottom: 8px; color: var(--primary); font-weight: 500; }
.form-control { width: 100%; padding: 12px 16px; background: rgba(255,255,255,0.05); border: 1px solid rgba(0,207,255,0.5); border-radius: 8px; color: #fff; }
textarea.form-control { min-height: 120px; }
.form-submit { background: linear-gradient(90deg,#00cfff,#3399ff); color: #000; border: none; padding: 14px 30px; border-radius: 8px; font-weight: 600; cursor: pointer; width: 100%; }
.order-info h3 { color: var(--primary); font-size: 1.5rem; margin-bottom: 20px; }
.info-item { margin-bottom: 18px; }
.info-item h4 { color: var(--primary); margin-bottom: 8px; display: flex; align-items: center; gap: 10px; font-size: 1.1rem; }
.info-item p { color: rgba(255,255,255,0.7); }
</style>
